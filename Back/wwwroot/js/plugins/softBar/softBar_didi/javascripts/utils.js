holly.utils = {
    ...
    showError: function (msg, objectId) {
        ...
        //     //"<img src='" + (hollyglobal.imgDir ? hollyglobal.imgDir : '.') + "~/js/plugins/softbar/softbar_didi/img/tip_error.png' style='float:left;margin-left:10px;'/>" +
        ...
        $.errorMsg("您的呼叫系统帐号在其他地方已经登录了，请退出ERP系统重新登录！");
    },
...
//                 "<div style='float:left;color:#666666;padding-left:5px;font-size:15px;padding-top:2px'>"+msg+"</div></div>";
    ...
    showTransferOrConsultError: function (msg, id) {
        debugger;
        var msgHtml = "<div style='height:34px;overflow:hidden;text-align:center;'><div style='overflow:hidden;padding-top:8px'>" +
            //"<img src='" + (hollyglobal.imgDir ? hollyglobal.imgDir : '.') + "~/js/plugins/softbar/softbar_didi/img/tip_error.png' style='float:left;margin-left:20px;'/>" +
